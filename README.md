# ⚛️ Quantum Random Number Generator (QRNG) Defense Prototype

> **AQVH1910** · Amaravati Quantum Valley Hackathon 2025 · Team: **Hackathon Warriors**

A comprehensive Quantum Random Number Generator system for defense and security applications, featuring quantum circuits, secure key distribution, AI anomaly detection, and a real-time monitoring dashboard.
...
| Component | Status |
|---|---|
| QRNG & QKD simulations | ✅ Functional |
| Flask APIs | ✅ Working |
| Dash monitoring dashboard | ✅ Live |
| AI anomaly detection | ⚠️ Rule-based prototype |
| Hardware integration | ⚠️ Planned (not deployed) |
...
### Current Setup (Software Simulation)
...
```python
# Replace AerSimulator with a real quantum backend
...
# For local QRNG hardware (USB/Serial)
# Compatible with: QRNG-USB, PicoQuant devices
```
...
│                 │    │                 │    │                 │
│ • QRNG Circuit  │◄──►│ • API Endpoints │◄──►│ • Live Monitor  │
...
- **India's National Quantum Mission** — ₹8,000 crore investment framework
...
| Anomaly Detection | < 100ms response time |
| Deployment | Multi-platform defense scalability |
...
Developed for **AQVH1910** — Quantum Based Defence and Security System
